<template>
  <div class="project">
    ...
    <div class="project__wrap">
      ...
      <template v-else><TemplateDataNone /></template>
    </div>
  </div>
  <Teleport to="#popup">
    <div
  ...
  <Teleport to="#popup">
    ...
    >
      ...
      <button
        type="button"
        class="setting__modal-btn"
        @click="popupAddGalleryIsOpen = true"
      >
        갤러리 등록
      </button>
      <button
        type="button"
        class="setting__modal-btn"
        @click="popupCreateTemplateIsOpen = true"
      >
        템플릿 등록
      </button>
      <div
  ...
  <PopupNewProject
    :is-open="popupNewProjectIsOpen"
    @close-button="popupNewProjectIsOpen = false"
  />
  <PopupRenameTitle
  ...
  />
  <PopupSelectTeamRoom
    :is-open="popupSelectTeamRoomIsOpen"
    @close-button="popupSelectTeamRoomIsOpen = false"
  />
  <PopupChooseFolder
  ...
  />
  <PopupAddGallery
    :is-open="popupAddGalleryIsOpen"
    @close-button="popupAddGalleryIsOpen = false"
  />
  <PopupCreateTemplate
    :is-open="popupCreateTemplateIsOpen"
    @close-button="popupCreateTemplateIsOpen = false"
  />
...
import PopupAddGallery from '@/containers/my-studio/MyProject/PopupAddGallery.vue';
import PopupChooseFolder from '@/containers/my-studio/MyProject/PopupChooseFolder.vue';
import PopupCreateTemplate from '@/containers/my-studio/MyProject/PopupCreateTemplate.vue';
import PopupFAQ from '@/containers/my-studio/MyProject/PopupFAQ.vue';
import PopupNewProject from '@/containers/my-studio/MyProject/PopupNewProject.vue';
...
import PopupSelectTeamRoom from '@/containers/my-studio/MyProject/PopupSelectTeamRoom.vue';
import ProjectFolderSideBar from '@/containers/my-studio/MyProject/ProjectFolderSideBar.vue';
...
const popupAddGalleryIsOpen = ref(false);
const popupCreateTemplateIsOpen = ref(false);
