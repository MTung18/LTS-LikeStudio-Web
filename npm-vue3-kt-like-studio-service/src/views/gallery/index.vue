...
<template>
  <div class="template">
    <div class="template__head">
      <h2 class="template__head-title">갤러리</h2>
      <SearchInput
        ...
        <div class="content">
          ...
          <div class="content__section">
            <div class="content__head">
              <h3 class="content__head-title">KT 임직원 베스트 갤러리</h3>
            </div>
            <SliderLayout @slide-click="handleOpenPopup" />
          </div>
          <div class="content__section">
            <div class="content__head">
              <h3 class="content__head-title">현장 베스트 갤러리</h3>
            </div>
            <SliderLayout @slide-click="handleOpenPopup" />
          </div>
          <div class="content__section">
...
.template__head {
  ...
  background-image: url('@/assets/img/img_gallery_banner.png');
