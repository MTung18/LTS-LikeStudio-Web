...
export class OnboardingWOTC8850Api extends AxiosBase {
  ...
  public async getOnboardingWOTC8850Hr(employeeId: number, formId: number) {
    let quickHireWOTC: UploadPayload<OnboardingWOTC8850Hr> = {} as UploadPayload<OnboardingWOTC8850Hr>;
    try {
      const response = await this.axiosInstance.get<UploadPayload<OnboardingWOTC8850Hr>>(
  ...
  public async updateOnboardingWOTC8850Hr(
    employeeId: number,
    formData: Partial<UploadPayload<OnboardingWOTC8850Hr>>
  ) {
    try {
      await this.axiosInstance.post<UploadPayload<OnboardingWOTC8850Hr>>(
...
export const onboardingWOTC8850HrApi = new OnboardingWOTC8850Api([
