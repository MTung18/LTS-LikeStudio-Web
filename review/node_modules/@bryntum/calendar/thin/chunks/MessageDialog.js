 ...
 *
 */
import { Base, DomHelper, GlobalEvents, Rectangle, Delayable, EventHelper, Events, ObjectHelper, _defineProperty, BrowserHelper, Widget, Point, Mask, Toast, StringHelper, LocaleManagerSingleton, DateHelper, DayTime, Panel, Tooltip, TimeZoneHelper, ArrayHelper, Field, _objectSpread2, TextField, Combo, PickerField, Container, Duration, VersionHelper, DomClassList, Popup } from './Editor.js';
...
_defineProperty(FieldFilterPicker, "defaultOperators", {
  string: [
  // In display order
  FieldFilterPicker.operators.empty, FieldFilterPicker.operators.notEmpty, FieldFilterPicker.operators['='], FieldFilterPicker.operators['!='], {
    value: 'includes',
    text: 'L{contains}'
  }, {
...
_defineProperty(FieldFilterPicker, "buildOperatorArgCountLookup", operators => ArrayHelper.keyBy(Object.entries(operators), ([fieldType]) => fieldType, ([, operators]) => ArrayHelper.keyBy(operators, ({
  value
}) => value, ({
  argCount
...
class FieldFilterPickerGroup extends Container {
  ...
  onStoreFilter(event) {
    ...
    const {
      ...
      storeFiltersById = filters.values.reduce((byId, filter) => _objectSpread2(_objectSpread2({}, byId), {}, {
        [filter.id]: filter
      }), {});
