 ...
 *
 */
import { Base, StringHelper, ObjectHelper, Store, _defineProperty, DateHelper, Collection, ArrayHelper } from './Editor.js';
...
var Describable = (Target => {
  var _class;
  return _class = class Describable extends (Target || Base) {
    /**
    ...
    get description() {
      ...
      const me = this,
        ...
        descriptionFormat = (_me$descriptionFormat = me.descriptionFormat) !== null && _me$descriptionFormat !== void 0 ? _me$descriptionFormat : arrayify(me.defaultDescriptionFormat);
      let end, ret;
