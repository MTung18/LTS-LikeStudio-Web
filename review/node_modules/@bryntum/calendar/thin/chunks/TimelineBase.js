...
import { _defineProperty, ObjectHelper, DateHelper, Duration, Widget, _objectSpread2, DomSync, EventHelper, DomHelper, StringHelper, DomClassList, Events, Model, IdHelper, Localizable, Store, unitMagnitudes, InstancePlugin, Objects, Tooltip, Rectangle, BrowserHelper, VersionHelper, Delayable, Base as Base$1, ArrayHelper, WalkHelper, DomDataStore, Scroller, ResizeMonitor, Collection, FunctionHelper } from './Editor.js';
...
import { ClockTemplate, AttachToProjectMixin, RecurringEvents } from './EventNavigation.js';
import './Slider.js';
...
class TimeAxis extends Store {
  ...
  getTickFromDate(date) {
    ...
    const me = this,
      ticks = me.records,
      dateMS = (_date$getTime = (_date$getTime2 = date.getTime) === null || _date$getTime2 === void 0 ? void 0 : _date$getTime2.call(date)) !== null && _date$getTime !== void 0 ? _date$getTime : date;
    let begin = 0,
      end = ticks.length - 1,
      middle,
      tick,
...
class DragBase extends InstancePlugin {
  ...
  onDragStart({
    ...
    const me = this,
      ...
      client = (_me$findClientFromTar = me.findClientFromTarget(event, context)) !== null && _me$findClientFromTar !== void 0 ? _me$findClientFromTar : me.client;
  ...
  updateDragContext(info, event) {
    ...
    if (constrainToTimeSlot) {
      ...
      if (client.timeAxis.isContinuous) {
        ...
        const timeAxisPosition = client.isHorizontal ? (_info$pageX = info.pageX) !== null && _info$pageX !== void 0 ? _info$pageX : info.startPageX : (_info$pageY = info.pageY) !== null && _info$pageY !== void 0 ? _info$pageY : info.startPageY,
...
class EventResize extends InstancePlugin.mixin(Draggable, Droppable) {
  ...
  async dragDrop({
    ...
    // Make sure dragged end end changed
    context.valid !== false;
    if (context.valid) {
  ...
  highlightHandle() {
    ...
    const {
      ...
      handleTargetElement = (_item$syncIdMap$clien = (_item$syncIdMap = item.syncIdMap) === null || _item$syncIdMap === void 0 ? void 0 : _item$syncIdMap[client.scheduledEventName]) !== null && _item$syncIdMap$clien !== void 0 ? _item$syncIdMap$clien : item.querySelector(client.eventInnerSelector);
  ...
  unHighlightHandle(item = this.overItem) {
    if (item) {
      ...
      const me = this,
        inner = (_item$syncIdMap$me$cl = (_item$syncIdMap2 = item.syncIdMap) === null || _item$syncIdMap2 === void 0 ? void 0 : _item$syncIdMap2[me.client.scheduledEventName]) !== null && _item$syncIdMap$me$cl !== void 0 ? _item$syncIdMap$me$cl : item.querySelector(me.client.eventInnerSelector);
      if (inner) {
  ...
  isElementResizable(element, event) {
    ...
    // a percent bar.
    const handleHoldingElement = (_element$syncIdMap$cl = (_element = element) === null || _element === void 0 ? void 0 : _element.syncIdMap[client.scheduledEventName]) !== null && _element$syncIdMap$cl !== void 0 ? _element$syncIdMap$cl : element,
...
class AbstractTimeRanges extends InstancePlugin.mixin(Delayable) {
  ...
  shouldRenderRange(range, startDate = this.client.visibleDateRange.startDate, endDate = this.client.visibleDateRange.endDate) {
    ...
    return Boolean(rangeStart && (!timeAxis.isFiltered || timeAxis.isTimeSpanInAxis(range)) && DateHelper.intersectSpans(startDate, endDate, rangeStart,
  ...
  renderRange(timeRange, startDate, endDate) {
    ...
    if (me.shouldRenderRange(timeRange, startDate, endDate) && timeAxis.startDate) {
      const config = me.getRangeDomConfig(timeRange, timeAxis.startDate, timeAxis.endDate),
        ...
        bodyConfig = _objectSpread2(_objectSpread2({}, config), {}, {
  ...
  return _class = class DependencyLineGenerator extends Target {
    ...
    prepareLineDef(dependency, fromAssignment, toAssignment, forceBoxes) {
      ...
      const me = this,
        ...
        startRectangle = (_forceBoxes$from = forceBoxes === null || forceBoxes === void 0 ? void 0 : forceBoxes.from) !== null && _forceBoxes$from !== void 0 ? _forceBoxes$from : me.getAssignmentBounds(fromAssignment),
        endRectangle = (_forceBoxes$to = forceBoxes === null || forceBoxes === void 0 ? void 0 : forceBoxes.to) !== null && _forceBoxes$to !== void 0 ? _forceBoxes$to : me.getAssignmentBounds(toAssignment),
        otherBoxes = [];
...
class Dependencies extends InstancePlugin.mixin(AttachToProjectMixin, Delayable, DependencyCreation, DependencyGridCache, DependencyLineGenerator, DependencyTooltip) {
  constructor(...args) {
    super(...args);
    _defineProperty(this, "domConfigs", new Map());
  ...
  getDependenciesToConsider(startMS, endMS, startIndex, endIndex) {
    ...
    return (_super$getDependencie = (_super$getDependencie2 = super.getDependenciesToConsider) === null || _super$getDependencie2 === void 0 ? void 0 : _super$getDependencie2.call(this, startMS, endMS, startIndex, endIndex)) !== null && _super$getDependencie !== void 0 ? _super$getDependencie :
...
var TimelineDomEvents = (Target => {
  ...
  return _class = class TimelineDomEvents extends (Target || Base$1) {
    constructor(...args) {
      ...
      _defineProperty(this, "hoveredEvents", new Set());
    }
    //endregion
    //region Init
    /**
...
var TimelineScroll = (Target => class TimelineScroll extends (Target || Base$1) {
    ...
    if (me.infiniteScroll) {
      const {
        ...
        centered = visibleDate && 'block' in visibleDate ? visibleDate.block === 'center' : true,
        {
          startDate,
          endDate
        } = me.timeAxisViewModel.calculateInfiniteScrollingDateRange(date, centered);
  ...
  scrollToDate(date, options = {}) {
    ...
    const scrollerViewport = me.timelineScroller.viewport,
      ...
      ? new Rectangle(me.getCoordinateFromDate(date, false), scrollerViewport.y, Math.min(me.timeAxisViewModel.tickSize, me.timeAxisViewModel.availableSpace), scrollerViewport.height) : new Rectangle(scrollerViewport.x, me.getCoordinateFromDate(date, false), scrollerViewport.width, me.timeAxisViewModel.tickSize);
