 ...
 *
 */
import { DateHelper, TimeZoneHelper, Store, _objectSpread2, Model, ObjectHelper, Events, Delayable, Base, ArrayHelper, StringHelper, Objects, _defineProperty, AjaxHelper, LoadMaskable, Mask, AjaxStore, FunctionHelper, DayTime, DomClassList, Duration, VersionHelper, BrowserHelper } from './Editor.js';
...
var AbstractCrudManagerMixin = (Target => {
  ...
  return _class = class AbstractCrudManagerMixin extends (Target || Base).mixin(...mixins) {
    /**
    ...
    applyChangesToStore(storeDesc, storeResponse, storePack) {
      ...
      if (updated.length && subStoreFields.length) {
        updated.forEach(updateData => {
          ...
          const record = store.getById((_updateData$phantomId = updateData[phantomIdField]) !== null && _updateData$phantomId !== void 0 ? _updateData$phantomId : updateData[idField]),
...
var EventStoreMixin = (Target => class EventStoreMixin extends (Target || Base) {
  ...
  getEventCounts(options) {
    const me = this,
      ...
      result = me.getEvents(_objectSpread2(_objectSpread2({}, options), {}, {
        ...
        for (let i = 0, {
          ...
          for (let bucket, i = 0, {
            ...
            const occurrence = occurrences[i],
              ...
              lastInteresctingDate = indexName === 'startDate' || occurrence.allDay ? DateHelper.add(date, 1, 'day') : DateHelper.min(occurrence.endDate || DateHelper.add(occurrence.startDate, occurrence.duration, occurrence.durationUnit), lastDate);
...
var TimeZonedDatesMixin = (Target => {
  ...
  return _class = class TimeZonedDatesMixin extends (Target || TimeSpan) {
    ...
    convertToTimeZone(timeZone) {
      const me = this,
        metaModified = _objectSpread2({}, me.meta.modified),
        convertFields = _objectSpread2({}, dateFieldsToConvert);
...
_defineProperty(AbstractRecurrenceIterator, "MAX_OCCURRENCES_COUNT", 1000000);
