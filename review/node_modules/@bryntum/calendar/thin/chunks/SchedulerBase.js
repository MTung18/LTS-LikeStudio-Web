 ...
 *
 */
import { _objectSpread2, _defineProperty, Base, InstancePlugin, Popup, ObjectHelper, Rectangle, Duration, Delayable, DomHelper, EventHelper, DateHelper, DomSync, StringHelper, VersionHelper, DomClassList, BrowserHelper, Store, GlobalEvents, ArrayHelper, Model } from './Editor.js';
        ...
        case 'update':
          {
            ...
            dateChanges && !('duration' in changes && dateChanges === 1) || 'percentDone' in changes || 'inactive' in changes || 'segments' in changes)) {
