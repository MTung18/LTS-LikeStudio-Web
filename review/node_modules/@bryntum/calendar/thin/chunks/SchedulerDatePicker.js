 ...
 *
 */
import { Localizable, DateHelper, InstancePlugin, ObjectHelper, Objects, Config, Popup, Store, Button, Base, _objectSpread2, Widget, Combo, DomHelper, Delayable, List, StringHelper, ArrayHelper, VersionHelper } from './Editor.js';
import { DateField, DatePicker } from './MessageDialog.js';
import { GridFeatureManager } from './GridBase.js';
import { RecurrenceFrequencyCombo } from './EventNavigation.js';
...
class ResourceFilter extends List {
  ...
  updateEventStore(eventStore) {
    ...
    const me = this,
      ...
      store = me.store = resourceStore.chain(me.masterFilter, null, _objectSpread2(_objectSpread2({}, chainedStoreConfig), {}, {
        syncOrder: true
      })),
      changeListeners = {
