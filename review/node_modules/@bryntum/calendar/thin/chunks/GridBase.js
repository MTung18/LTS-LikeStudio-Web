...
class Location {
  ...
  get isActionable() {
    const {
      ...
      containsFocus = (cell === null || cell === void 0 ? void 0 : cell.compareDocumentPosition(DomHelper.getActiveElement(cell))) & Node.DOCUMENT_POSITION_CONTAINED_BY;
  ...
  async startEditing(cellContext = {}) {
    ...
    if (!me.disabled) {
      ...
      if (grid.store.isTree && grid.features.tree) {
        ...
        const record = cellContext.id ? grid.store.getById(cellContext.id) : (_cellContext$record = cellContext.record) !== null && _cellContext$record !== void 0 ? _cellContext$record : grid.store.getAt(cellContext.row);
        if (record) {
...
class GridFieldFilterPicker extends FieldFilterPicker {
  ...
  afterConstruct() {
    ...
    me.fields = (_me$fields = me.fields) !== null && _me$fields !== void 0 ? _me$fields : {}; // Force `fields` changer if fields is left null, to merge w/ grid fields
...
class Filter extends InstancePlugin {
  ...
  getMultiFilterPopupItems(column) {
    ...
    return [_objectSpread2(_objectSpread2({}, typeof isMulti === 'object' ? isMulti : undefined), {}, {
  ...
  return _class = class GridSelection extends (Target || Base) {
    ...
    onCellNavigate(me, fromCellSelector, toCellSelector, doSelect) {
      ...
      const {
        ...
        currentTarget = currentEvent === null || currentEvent === void 0 ? void 0 : currentEvent.target;
      ...
      currentTarget && rowReorder !== null && rowReorder !== void 0 && rowReorder.gripOnly && rowReorder.isElementDraggable(currentTarget, currentEvent) || (currentEvent === null || currentEvent === void 0 ? void 0 : currentEvent.handled) === true) {
        return;
      }
