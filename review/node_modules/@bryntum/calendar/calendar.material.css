...
.b-datepicker .b-toolbar.b-dock-top .b-button.b-icon, .b-datepicker .b-toolbar.b-dock-top .b-button.b-icon:not(.b-tab):active:not([disabled]), .b-datepicker .b-toolbar.b-dock-top .b-button.b-icon:not(.b-tab):active:focus:not([disabled]) {
  color: #888;
}
...
.b-datetimefield .b-datefield .b-field-inner {
  border: none;
  border-inline-end: 1px solid #9e9e9e;
  border-top-right-radius: 0;
  border-bottom-right-radius: 0;
}
...
.b-toolbar.b-dock-top .b-toolbar-content > .b-toolbar-separator, .b-toolbar.b-dock-bottom .b-toolbar-content > .b-toolbar-separator {
  ...
  border-inline-end-color: #f2f2f2;
}
...
@font-face {
  font-family: Roboto;
  src: url("fonts/Roboto-Light.woff2") format("woff2"), url("fonts/Roboto-Light.woff") format("woff"); /* Pretty Modern Browsers */
  font-weight: 300;
}
@font-face {
  font-family: Roboto;
  src: url("fonts/Roboto-Regular.woff2") format("woff2"), url("fonts/Roboto-Regular.woff") format("woff"); /* Pretty Modern Browsers */
  font-weight: 400;
}
@font-face {
  font-family: Roboto;
  src: url("fonts/Roboto-Medium.woff2") format("woff2"), url("fonts/Roboto-Medium.woff") format("woff"); /* Pretty Modern Browsers */
  font-weight: 500;
}
@font-face {
  font-family: Roboto;
  src: url("fonts/Roboto-Bold.woff2") format("woff2"), url("fonts/Roboto-Bold.woff") format("woff"); /* Pretty Modern Browsers */
  font-weight: 700;
}
.b-widget {
...
.b-content-icon, .b-gridbase.b-columnresize.b-touch.b-column-resizing .b-grid-header.b-resizing::before, .b-grid-cell.b-group-title:before {
  -webkit-font-smoothing: antialiased;
  -moz-osx-font-smoothing: grayscale;
  display: inline-block;
  font-style: normal;
...
.b-eventeditor.b-popup {
  width: calc(15em + var(--date-time-length));
  min-width: calc(15em + var(--date-time-length));
  flex: unset;
}
...
.b-stickyevents.b-sch-horizontal .b-sch-event-wrap:not(.b-disable-sticky) .b-sch-event-content,
...
.b-timeline-subgrid .b-selected-time-span {
  background: rgba(161, 210, 250, 0.2);
}
...
.b-cal-event-bar-container .b-cal-event-wrap:not(.b-allday) .b-cal-event {
...
.b-calendardatepicker .b-calendar-cell.b-selected-date:not(.b-in-range) > .b-datepicker-cell-inner {
  background-color: #5fa2dd;
  border-color: #5fa2dd;
}
...
.b-dayview-timeaxis-tick {
  ...
  max-height: var(--leaf-tick-height);
  flex: 1 0 0%;
  display: flex;
  flex-direction: column;
  justify-content: flex-end;
...
.b-cal-event-bar-container .b-cal-event-wrap.b-solid-bar .b-cal-event-icon.b-icon-circle:before {
  content: none;
}
