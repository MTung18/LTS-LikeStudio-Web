...
.b-daycellcollecter .b-dayview-content {
    ...
    // Avatars only wrap in DayView event blocks.
...
.b-dayview-day-container {
    ...
    .b-calendar-cell:not(.b-last-cell) {
    ...
    .b-cal-event-wrap.b-selected:not(.b-dragging-item):hover .b-cal-event-body,
    .b-cal-event-wrap.b-selected:not(.b-dragging-item) .b-cal-event-body,
    .b-cal-event-wrap.b-cal-tentative-event .b-cal-event-body {
