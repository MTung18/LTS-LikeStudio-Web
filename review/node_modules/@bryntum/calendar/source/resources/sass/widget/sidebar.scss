...
.b-calendar {
    .b-sidebar {
        // Flex-basis is auto, and the List items in the Resources widget are white-space:nowrap
        // So we need to limit how much space we can steal from the calendar content.
        max-width : 30%;
