...
$calendar-today-hover-background-color          : scale-color($calendar-today-background-color, $lightness : -20%) !default;
...
$dayview-event-body-padding                     : .3em .5em 0 !default;
$dayview-event-body-margin                      : 0 0 0 .25em !default;
...
$dayview-inset-background-color                 : scale_color($dayview-nonworking-day-background-color, $lightness : 5%) !default;
$dayview-time-indicator-color                   : $red !default;
$dayview-today-background-color                 : null !default;
$dayview-time-axis-color                        : scale_color($dayview-foreground-color, $lightness : 50%) !default;
// Should stand out more than tick lines and minor ticks
$dayview-time-axis-hour-color                   : darken($dayview-time-axis-color, 20%) !default;
...
$yearview-1-to-3-events-color                   : #f9f69e !default;
$yearview-4-to-6-events-color                   : #f9d49e !default;
$yearview-7-or-more-events-color                : #f9bdb3 !default;
