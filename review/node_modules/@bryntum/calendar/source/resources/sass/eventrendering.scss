...
@mixin calendar-event() {
    ...
    .b-cal-event-wrap {
        ...
        //&.b-past-event {
        // Do we want them displayed differently?
        //}
        ...
        &.b-active:not(.b-dragging-item) {
            outline : none;

            // Need to override the b-overflow rule for opacity : 0
            opacity : 1 !important;
    ...
    .b-cal-event {
        ...
        .b-cal-event-icon, .b-cal-recurrence-icon {
            flex-shrink : 0;
            display     : flex;

            // Override fixed width applied to icons
            width       : auto;

            &:before {
                font-size : $cal-event-icon-font-size;
            }
        }
    }
    ...
    .b-cal-event-bar-container {
        .b-cal-event-wrap {
            ...
            &.b-solid-bar {
                ...
                // No default bullet icon for all day events.
                .b-cal-event-icon.b-icon-circle:before {
                    content : none;
                }
            }
        }
    ...
    .b-cal-event-name {
        margin-inline-start : $cal-event-bar-gap;
        overflow            : hidden;
...
.b-daycellrenderer {
    ...
    .b-cal-cell-overflow:not(.b-calendar-cell), .b-cal-cell-no-content {
        ...
        margin           : 0 $monthview-event-padding;
        font-family      : inherit;
        ...
        &.b-active {
            outline         : 0 none;
            font-weight     : bold;
            color           : darken($calendar-cell-overflow-color, 35);
        }
    }
...
// Intraday events in DayCellRenderer + overflow uses color
