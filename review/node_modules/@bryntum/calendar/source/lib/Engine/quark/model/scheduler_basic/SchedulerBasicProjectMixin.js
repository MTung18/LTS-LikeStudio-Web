        ...
        *subEventsIterable() {
        ...
        deferUntilRepopulationIfNeeded(deferId, func, args) {
            if (this.isRepopulatingStores) {
                ...
                this.ion({
                    name: deferId,
                    repopulateReplica: { fn: () => func(...args), once: true }
                });
            }
            else {
                func(...args);
        ...
        *calculateEffectiveCalendar() {
        ...
        isEngineReady() {
            ...
            return this.delayEnteringReplica
                || (!this.isRepopulatingStores && (replica ? !(replica.dirty && (replica.hasPendingAutoCommit() || replica.isCommitting)) : true));
        }
