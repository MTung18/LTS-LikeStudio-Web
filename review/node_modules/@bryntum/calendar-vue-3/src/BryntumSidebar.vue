<!-- Vue 3 wrapper for Bryntum Sidebar -->
...
<script>
import { Layout, Model, PanelCollapser, Rectangle, Scroller, Sidebar, StateProvider, Tool, Widget } from '@bryntum/calendar';
