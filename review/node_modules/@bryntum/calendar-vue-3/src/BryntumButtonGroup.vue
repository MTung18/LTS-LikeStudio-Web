...
<script>
import { Button, ButtonGroup, Layout, Model, Rectangle, Scroller, Widget } from '@bryntum/calendar';
...
export default {
    ...
    props : {
        ...
        toggleGroup             : { type : Boolean, default : undefined },
