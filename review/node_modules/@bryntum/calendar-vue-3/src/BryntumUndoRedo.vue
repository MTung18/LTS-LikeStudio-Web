...
<script>
import { Layout, Model, Rectangle, SchedulerProjectModel, Scroller, UndoRedo, Widget } from '@bryntum/calendar';
...
export default {
    ...
    props : {
        ...
        scheduler               : { type : [Widget, String], default : undefined },
        ...
        showZeroActionBadge     : { type : Boolean, default : undefined },
