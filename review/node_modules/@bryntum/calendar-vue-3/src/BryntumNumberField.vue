...
<script>
import { FieldContainer, NumberField, Rectangle, Scroller, Widget } from '@bryntum/calendar';
...
export default {
    ...
    props : {
        ...
        changeOnSpin            : { type : [Boolean, Number], default : undefined },
        ...
        leadingZeroes           : { type : Number, default : undefined },
