...
<script>
import { Layout, Model, Rectangle, Scroller, TimePicker, Widget } from '@bryntum/calendar';
...
export default {
    ...
    props : {
        ...
        initialValue    : { type : [Date, String], default : undefined },
        ...
        onTimeChange      : { type : Function, default : undefined },
