...
<script>
import { DateField, FieldContainer, Rectangle, Scroller, Widget } from '@bryntum/calendar';
...
export default {
    ...
    props : {
        ...
        keepTime                : { type : [Boolean, Date, String], default : undefined },
        ...
        strictParsing           : { type : Boolean, default : undefined },
        ...
        step         : { type : [String, Number, Object], default : undefined },
