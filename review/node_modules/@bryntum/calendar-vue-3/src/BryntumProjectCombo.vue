...
<script>
import { FieldContainer, ProjectCombo, Rectangle, SchedulerProjectModel, Scroller, Store, Widget } from '@bryntum/calendar';
...
export default {
    ...
    props : {
        ...
        project                 : { type : SchedulerProjectModel, default : undefined },
