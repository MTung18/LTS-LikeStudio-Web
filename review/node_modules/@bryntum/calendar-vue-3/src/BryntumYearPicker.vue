...
<script>
import { Layout, Model, PanelCollapser, Rectangle, Scroller, StateProvider, Tool, Widget, YearPicker } from '@bryntum/calendar';
...
export default {
    ...
    props : {
        ...
        yearButtonCount         : { type : Number, default : undefined },
