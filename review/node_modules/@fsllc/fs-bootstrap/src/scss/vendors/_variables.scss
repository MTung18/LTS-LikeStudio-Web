...
//
// Variables beginning with `$fsv-` are used to enable/disable specific section CSS generation
...
$b-custom-control-indicator-size-lg: $form-check-input-width * 1.25 !default;
$b-custom-control-indicator-size-sm: $form-check-input-width * 0.875 !default;

// Indicator background
$b-custom-control-indicator-bg-size-lg: 50% 50% !default;
$b-custom-control-indicator-bg-size-sm: 50% 50% !default;
...
//   #{$b-custom-control-indicator-size-lg} - #{$form-check-input-border * 4}
// ) !default;
// $b-custom-switch-indicator-size-sm: calc(
//   #{$b-custom-control-indicator-size-sm} - #{$form-check-input-border * 4}
// ) !default;
...
$fs-sidebar-width: 320px !default;
$fs-sidebar-transition-duration: 0.3s !default;
$fs-sidebar-zindex: calc(#{$zindex-fixed} + 5) !default;
$fs-sidebar-header-font-size: 1.5rem !default;
$fs-sidebar-header-padding-y: $navbar-padding-y !default;
$fs-sidebar-header-padding-x: $navbar-padding-x !default;

// --- Tables ---

// Table busy state
$fs-table-busy-opacity: 0.55 !default;

// Table sorting
$fs-table-sort-icon-bg-width: 0.65em !default;
$fs-table-sort-icon-bg-height: 1em !default;
// Sort icons are square, but "squished" horizontally by the above variables
$fs-table-sort-icon-bg-not-sorted: url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' width='101' height='101' view-box='0 0 101 101' preserveAspectRatio='none'><path fill='black' opacity='.3' d='M51 1l25 23 24 22H1l25-22zM51 101l25-23 24-22H1l25 22z'/></svg>") !default;
$fs-table-sort-icon-bg-ascending: url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' width='101' height='101' view-box='0 0 101 101' preserveAspectRatio='none'><path fill='black' d='M51 1l25 23 24 22H1l25-22z'/><path fill='black' opacity='.3' d='M51 101l25-23 24-22H1l25 22z'/></svg>") !default;
$fs-table-sort-icon-bg-descending: url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' width='101' height='101' view-box='0 0 101 101' preserveAspectRatio='none'><path fill='black' opacity='.3' d='M51 1l25 23 24 22H1l25-22z'/><path fill='black' d='M51 101l25-23 24-22H1l25 22z'/></svg>") !default;
...
$fs-table-sort-icon-bg-dark-not-sorted: url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' width='101' height='101' view-box='0 0 101 101' preserveAspectRatio='none'><path fill='white' opacity='.3' d='M51 1l25 23 24 22H1l25-22zM51 101l25-23 24-22H1l25 22z'/></svg>") !default;
$fs-table-sort-icon-bg-dark-ascending: url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' width='101' height='101' view-box='0 0 101 101' preserveAspectRatio='none'><path fill='white' d='M51 1l25 23 24 22H1l25-22z'/><path fill='white' opacity='.3' d='M51 101l25-23 24-22H1l25 22z'/></svg>") !default;
$fs-table-sort-icon-bg-dark-descending: url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' width='101' height='101' view-box='0 0 101 101' preserveAspectRatio='none'><path fill='white' opacity='.3' d='M51 1l25 23 24 22H1l25-22z'/><path fill='white' d='M51 101l25-23 24-22H1l25 22z'/></svg>") !default;

// Flag to enable sticky table header and column CSS generation
$fsv-enable-table-sticky: true !default;

// Default max-height for tables with sticky headers
$fs-table-sticky-header-max-height: 300px !default;

// Flag to enable table stacked CSS generation
$fsv-enable-table-stacked: true !default;
// Table stacked defaults
$fs-table-stacked-heading-width: 40% !default;
$fs-table-stacked-gap: 1rem !default;
...
$b-toast-bg-level: $alert-bg-scale !default;
$b-toast-border-level: $alert-border-scale !default;
$b-toast-color-level: $alert-color-scale !default;

// --- Tooltips ---

// Flag to enable tooltip variant CSS generation
$fsv-enable-tooltip-variants: true !default;
...
$fsv-enable-popover-variants: true !default;

// // Popover variant levels wrt theme color value
$b-popover-bg-level: $alert-bg-scale !default;
$b-popover-border-level: $alert-border-scale !default;
$b-popover-color-level: $alert-color-scale !default;
